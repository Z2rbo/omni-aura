...
const phases: Phase[] = [
  ...
  },
  {
    ...
    status: "done",
    icon: Flag,
    pitch: "Собрали MVP, прошли экспертизу, защитили проект в конкурсе стартапов.",
    items: [
      ...
      { date: "Апр 2026", title: "Защита проекта", sub: "Финал конкурса стартапов" },
    ],
  },
  {
    n: "03",
...
export function Roadmap() {
  return (
    <Section
      ...
      lead="Путь проекта разбит на четыре фазы. Мы внутри третьей: конкурс прошли, MVP в сторе, ведём выход на рынок."
