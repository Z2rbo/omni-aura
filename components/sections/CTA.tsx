...
export function CTA() {
  ...
  return (
    <section id="cta" className="relative overflow-hidden px-6 pb-32 md:px-10">
      <div className="mx-auto grid max-w-7xl items-center gap-10 overflow-hidden rounded-[44px] bg-ink p-10 text-white md:grid-cols-12 md:p-16 lg:p-20">
        {/* Aurora decoration */}
        <div
          aria-hidden
        ...
        <Reveal className="relative md:col-span-7">
          ...
          <h2 className="mt-6 text-balance text-5xl font-extrabold leading-[1.02] tracking-tighter md:text-6xl lg:text-7xl">
            Готов поменять{" "}
            <span className="bg-[linear-gradient(110deg,#B8A1FF,#FFFFFF)] bg-clip-text text-transparent">
              отношение к телу?
            </span>
          </h2>
          <p className="mt-6 max-w-xl text-pretty text-lg text-white/70 md:text-xl">
